        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mx-auto mb-2 mb-md-0">
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 {{ request()->routeIs('berita') ? 'active' : '' }}"
                        href="{{ route('berita') }}"
                        style="border-radius: 50px; font-size: 13px; font-weight: 600; letter-spacing: 0.5px;">
                        <i class="fa fa-book-open mr-1"></i> BERITA
                    </a>
                </li>
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 {{ request()->routeIs('produk') ? 'active' : '' }}"
                        href="{{ route('produk') }}"
                        style="border-radius: 50px; font-size: 13px; font-weight: 600; letter-spacing: 0.5px;">
                        <i class="fa fa-box-open mr-1"></i> PRODUK
                    </a>
                </li>
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 {{ request()->routeIs('order') ? 'active' : '' }}"
                        href="{{ route('order') }}"
                        style="border-radius: 50px; font-size: 13px; font-weight: 600; letter-spacing: 0.5px;">
                        <i class="fa fa-cart-plus mr-1"></i> ORDER
                    </a>
                </li>
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 {{ request()->routeIs('kontak') ? 'active' : '' }}"
                        href="{{ route('kontak') }}"
                        style="border-radius: 50px; font-size: 13px; font-weight: 600; letter-spacing: 0.5px;">
                        <i class="fa fa-phone mr-1"></i> KONTAK
                    </a>
                </li>
            </ul>
